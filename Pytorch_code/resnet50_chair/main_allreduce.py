...
parser.add_argument('--port', default='23216', type=str)
...
parser.add_argument('--train-source', default='/mnt/lustre/yangkunlin/furniture/data/chair_train.txt', type=str)
parser.add_argument('--val-root', default='/mnt/lustre/yangkunlin/furniture/data/val/', type=str)
parser.add_argument('--val-source', default='/mnt/lustre/yangkunlin/furniture/data/chair_valid.txt', type=str)
parser.add_argument('--save-path', default='checkpoint1', type=str)
...
def main():
    ...
    if args.arch.startswith('inception_v3'):
        ...
        input_size = 224
        model = models.__dict__[args.arch](pretrained=True)
    model = FineTuneModel(model, args.arch, 9)
