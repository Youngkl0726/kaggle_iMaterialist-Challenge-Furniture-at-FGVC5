...
test_source = "/mnt/lustre/yangkunlin/furniture/data/chair_test.txt"
image_size = 256
input_size = 224
batch_size = 16
arch = "resnet50"
ckp_path = "/mnt/lustre/yangkunlin/furniture/pytorch/resnet50_chair/checkpoint1_best.pth.tar"
...
def main():
    ...
    for trans in TTA10_preprocess:
        ...
        model = FineTuneModel(model, arch, 9)
        # model.cuda()
