...
parser.add_argument('--port', default='23566', type=str)
...
parser.add_argument('--save-path', default='checkpoint5', type=str)
...
class FinetunePretrainedModels(nn.Module):
    ...
    def forward(self, x):
        return self.net(x)
model_dict = {
    'resnext101_32x4d': partial(FinetunePretrainedModels, NB_CLASSES, resnext.resnext101_32x4d)
}
...
def main():
    ...
    # create model
    print("=> creating model '{}'".format("resnext101_32x4d"))
    print("save_path is: {}".format(args.save_path))

    image_size = 256
    input_size = 224
    model = get_model('resnext101_32x4d', pretrained=True)
