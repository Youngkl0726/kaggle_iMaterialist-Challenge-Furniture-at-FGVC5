...
batch_size = 16
arch = "senet154"
ckp_path = "/mnt/lustre/yangkunlin/furniture/pytorch/resnext101_32x4d/checkpoint5_best.pth.tar"
...
def main():
    ...
    for trans in TTA10_preprocess:
        ...
        print("test loading....")
        model = get_model('resnext101_32x4d', pretrained=False)
        # model.cuda()
        ...
        np.save("./rst/resnext101_32x4d_ck5{}.npy".format(id), pred)
        id += 1
    # print("test loading....")
