...
model_dict = {
    'dpn92': partial(FinetunePretrainedModels, NB_CLASSES, dpn.dpn92)
}
...
batch_size = 16
arch = "dpn92"
ckp_path = "/mnt/lustre/yangkunlin/furniture/pytorch/dpn92/checkpoint6_best.pth.tar"
...
def main():
    ...
    for trans in TTA10_preprocess:
        ...
        print("test loading....")
        model = get_model('dpn92', pretrained=False)
        # model.cuda()
        ...
        np.save("./rst/dpn92_ck6{}.npy".format(id), pred)
        id += 1
    # print("test loading....")
