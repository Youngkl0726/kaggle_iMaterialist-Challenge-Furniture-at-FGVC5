...
model_dict = {
    'xception': partial(FinetunePretrainedModels, NB_CLASSES, xception.xception)
}
...
batch_size = 16
arch = "xception"
ckp_path = "/mnt/lustre/yangkunlin/furniture/pytorch/xception/checkpoint2_best.pth.tar"
...
def main():
    ...
    for trans in TTA10_preprocess:
        ...
        np.save("./rst/xception_ck2{}.npy".format(id), pred)
        id += 1
    # print("test loading....")
