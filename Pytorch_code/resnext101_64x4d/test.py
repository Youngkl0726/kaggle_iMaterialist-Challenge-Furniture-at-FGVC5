...
model_dict = {
    'resnext101_64x4d': partial(FinetunePretrainedModels, NB_CLASSES, resnext.resnext101_64x4d)
}
...
ckp_path = "/mnt/lustre/yangkunlin/furniture/pytorch/resnext101_64x4d/checkpoint2_best.pth.tar"
...
def main():
    ...
    for trans in TTA10_preprocess:
        ...
        print("test loading....")
        model = get_model('resnext101_64x4d', pretrained=False)
        # model.cuda()
        ...
        np.save("./rst/resnext101_64x4d_ck2{}.npy".format(id), pred)
        id += 1
