...
batch_size = 16
arch = "senet154"
ckp_path = "/mnt/lustre/yangkunlin/furniture/pytorch/seresnet152/checkpoint4_best.pth.tar"
...
def main():
    ...
    for trans in TTA10_preprocess:
        ...
        print("test loading....")
        model = get_model('se_resnet152', pretrained=False)
        # model.cuda()
        ...
        np.save("./rst/se_resnet152_ck4{}.npy".format(id), pred)
        id += 1
    # print("test loading....")
