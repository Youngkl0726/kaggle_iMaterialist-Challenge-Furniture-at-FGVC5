...
parser.add_argument('--port', default='23896', type=str)
...
parser.add_argument('--train-source', default='/mnt/lustre/yangkunlin/furniture/data/Pseudo-Label2.txt', type=str)
...
class FinetunePretrainedModels(nn.Module):
    ...
    def forward(self, x):
        return self.net(x)
model_dict = {
    'se_resnet152': partial(FinetunePretrainedModels, NB_CLASSES, senet.se_resnet152)
}
...
def main():
    ...
    # create model
    print("=> creating model '{}'".format("se_resnet152"))
    print("save_path is: {}".format(args.save_path))

    image_size = 256
    input_size = 224
    model = get_model('se_resnet152', pretrained=True)
