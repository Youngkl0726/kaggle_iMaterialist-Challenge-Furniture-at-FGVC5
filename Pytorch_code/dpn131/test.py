...
model_dict = {
    'dpn131': partial(FinetunePretrainedModels, NB_CLASSES, dpn.dpn131)
}
...
batch_size = 16
arch = "dpn131"
ckp_path = "/mnt/lustre/yangkunlin/furniture/pytorch/dpn131/checkpoint6_best.pth.tar"
...
def main():
    ...
    for trans in TTA10_preprocess:
        ...
        print("test loading....")
        model = get_model('dpn131', pretrained=False)
        # model.cuda()
        ...
        np.save("./rst/dpn131_ck6{}.npy".format(id), pred)
        id += 1
