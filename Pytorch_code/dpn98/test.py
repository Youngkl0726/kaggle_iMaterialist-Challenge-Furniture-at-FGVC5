...
batch_size = 16
arch = "dpn98"
ckp_path = "/mnt/lustre/yangkunlin/furniture/pytorch/dpn98/checkpoint3_best.pth.tar"
...
def main():
    ...
    for trans in TTA10_preprocess:
        ...
        print("test loading....")
        model = get_model('dpn98', pretrained=False)
        # model.cuda()
        ...
        np.save("./rst/dpn98_ck3{}.npy".format(id), pred)
        id += 1
    # print("test loading....")
